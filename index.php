...
<html lang="en">
    <head>
        ...
        <title>Rilstaurant Food & Drink</title>
    </head>
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">Rilstaurant</a>

                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item"><a href="#home" class="nav__link active-link">Home</a></li>
                        <li class="nav__item"><a href="#about" class="nav__link">Tentang Kami</a></li>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Rilstaurant food</h1>
                        <h2 class="home__subtitle">Coba Makanan Terbaik<br>Kamu Disini.</h2>
                        <a href="menu/index.php" class="button">Lihat Menu</a>
                    </div>
    
                    <img src="img/plate5.png" alt="" class="home__img">
                </div>
            </section>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Kami memasak makanan terbaik <br> di Rilstaurant</h2>
                        <p class="about__description">Kami memasak makanan terbaik di seluruh kota, dengan pelayanan pelanggan yang luar biasa, hidangan terbaik, dan harga yang terjangkau, kunjungi kami.</p>
            ...
            <section class="services section bd-container" id="services">
                <span class="section-subtitle">Kelebihan Kami</span>
                ...
                <div class="services__container  bd-grid">  
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Makanan Yang Lezat</h3>
                        <p class="services__description">Kami menawarkan kepada klien kami layanan berkualitas tinggi selama bertahun-tahun, dengan makanan terbaik dan lezat di kota.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <p class="services__description">Kami menawarkan makanan cepat saji yang menyehatkan dan dimasak menggunakan bahan terbaik oleh chef profesional kami.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Pengantaran</h3>
                        <p class="services__description">Kami menawarkan Pengantaran Makanan Yang Kilat, Sehingga Makanan kami Dapat kamu Nikmati dalam Kondisi Hangat.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        <span class="section-subtitle contact__initial">Ayo Hubungi Kami</span>
                    ...
                    <div class="contact__button">
                        <a href="#" class="button" id="whatsapp-button">Hubungi Sekarang</a>
                    </div>
                </div>
            </section>
        </main>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Rilstaurant</a>
                    <span class="footer__description">Food & Drinks</span>
                    <div>
                        <a href="https://www.facebook.com/pahlawan.senja.146" class="footer__social"><i class='bx bxl-facebook'></i></a>
                        <a href="https://www.instagram.com/syahrilmaymubdimandai/" class="footer__social"><i class='bx bxl-instagram'></i></a>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li><a href="#" class="footer__link">Pengiriman</a></li>
                        <li><a href="#" class="footer__link">Harga</a></li>
                        <li><a href="#" class="footer__link">Makanan cepat saji</a></li>
                        <li><a href="admin/login_admin.php" class="footer__link">Layanan Admin</a></li>
                    </ul>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li><a href="#" class="footer__link">Acara</a></li>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li>Syahril May Mubdi</li>
                        <li>0822-6740-3010</li>
                        <li>syahrilmaymubdi2505@gmail.com</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; 2024 Syahril. All right reserved</p>
        </footer>
